...
const en: Record<string, string> = {
  ...
  "prov.li3": "Price in sats today; fiat-denominated pricing on the roadmap",
  ...
  "agt.li3": "Discover paid capabilities across the network (marketplace, soon)",
...
const ru: Record<string, string> = {
  ...
  "prov.li3": "Сейчас цена в сатоши; цена в фиате — в дорожной карте",
  ...
  "agt.li3": "Находите платные возможности по сети (маркетплейс — скоро)",
...
const ja: Record<string, string> = {
  ...
  "prov.li3": "現在はサトシ建て。法定通貨建てはロードマップに",
  ...
  "agt.li3": "ネットワーク上の有料機能を発見（マーケットプレイスは近日）",
